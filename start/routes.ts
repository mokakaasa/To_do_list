...
Route.get('/searchall', 'ToDoListsController.searchall');
...
Route.get('/display/:id', 'ToDoListsController.display');
...
Route.post('/updatename/:id', 'ToDoListsController.updatename');
